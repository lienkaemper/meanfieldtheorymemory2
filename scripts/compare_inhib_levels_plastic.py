...
for trial in range(4):
    ...
    for g in gs:
        ...
        for h in [1,2]:
            h_i1, h_i3  = find_iso_rate_ca3(yca1= y_baseline_new[3], yca3 = y_baseline_new[0], h=h, J0 = J0, g=g, g_ii=g_ii, b = b_iso, h_i_min = 1, h_i_max = 4, type = "quadratic", n_points = 1000)
            h_list.append(h)
            g_list.append(g)
...
with open("../results/compare_inhib_levels/raw_df.pkl", "wb") as f:
