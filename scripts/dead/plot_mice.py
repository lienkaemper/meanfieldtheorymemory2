...
sns.barplot(data = corr_cfc, x = "region", hue = "condition", y = "correlation").set_ylim(0, 0.008)
plt.title("HC")
plt.title("CFC")
plt.savefig("../results/mouse_correlation_cfc.pdf")

plt.figure(figsize=(5,7)) 
sns.barplot(data = corr_tfc, x = "region", hue = "condition", y = "correlation").set_ylim(0, 0.008)
plt.title("TFC")
plt.savefig("../results/mouse_correlation_tfc.pdf")

plt.figure(figsize=(5,7)) 
sns.barplot(data = corr_hc, x = "region", hue = "condition", y = "correlation").set_ylim(0, 0.008)
plt.title("HC")
plt.savefig("../results/mouse_correlation_hc.pdf")


plt.figure(figsize=(5,7)) 
bp = sns.barplot(data = rate_cfc, x = "region", hue = "condition", y = "rate").set_ylim(0, 0.3)
plt.title("CFC")
plt.savefig("../results/mouse_rate_cfc.pdf")

plt.figure(figsize=(5,7)) 
sns.barplot(data = rate_tfc, x = "region", hue = "condition", y = "rate").set_ylim(0, 0.3)
plt.title("TFC")
plt.savefig("../results/mouse_rate_tfc.pdf")

plt.figure(figsize=(5,7)) 
sns.barplot(data = rate_hc, x = "region", hue = "condition", y = "rate").set_ylim(0, 0.3)
plt.title("HC")
